...
func TestAgingClockwise(t *testing.T) {
	...
	aux := []struct {
		days, expectedValue float64
	}{
		{days: 1, expectedValue: 359},
		{days: 7, expectedValue: 352},
		{days: 30, expectedValue: 322},
		{days: 360, expectedValue: 322},
	}
...
func TestAgingCounterclockwise(t *testing.T) {
	...
	aux := []struct {
		...
		{days: 3, expectedValue: 15},
		{days: 7, expectedValue: 43},
		{days: 30, expectedValue: 163},
		{days: 360, expectedValue: 163},
	}
